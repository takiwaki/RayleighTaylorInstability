module boundarymod
  ...
  integer,parameter:: boundary_xin=outflow, boundary_xout=outflow
  integer,parameter:: boundary_yin=outflow, boundary_yout=outflow
  integer,parameter:: boundary_zin=outflow, boundary_zout=outflow
