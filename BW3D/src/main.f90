...
subroutine GenerateProblem
  ...
  do i=is-mgn,ie+mgn
     d(i,j,k) = 1.0d0
     if(x1b(i)**2 +x2b(j)**2 +x3b(k)**2 < 0.1d0**2)then
        p(i,j,k) = 10.0d0
        Xcomp(1,i,j,k) = 1.0d0
     else
        p(i,j,k) = 1.0d0
     ...
     v2(i,j,k) = 0.0d0
     v3(i,j,k) = 0.0d0
     b1(i,j,k) = B0/sqrt(3.0d0)
     b2(i,j,k) = B0/sqrt(3.0d0)
     b3(i,j,k) = 0.0d0
     bp(i,j,k) = 0.0d0
  enddo
  enddo
  ...
  do j=js-mgn,je+mgn
  do i=is-mgn,ie+mgn
     if((x1b(i)-0.3)**2 +(x2b(j)-0.3)**2+(x3b(k)-0.3)**2 < 0.1d0**2)then
        d(i,j,k) = d(i,j,k) + 100.0d0
     endif
     
     if((x1b(i)+0.28)**2 +(x2b(j)+0.28)**2+(x3b(k)+0.3)**2 < 0.1d0**2)then
        d(i,j,k) = d(i,j,k) + 100.0d0
     endif
  enddo
  enddo
